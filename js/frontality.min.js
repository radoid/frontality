...
"*/json")},xhr:function(){var b=a.ajaxSettings.xhr();b.upload&&"function"==typeof g&&b.upload.addEventListener("progress",function(a){DEBUG&&console.log("Upload progress:",a.loaded,a.total);a.lengthComputable&&"function"==typeof g&&g.call(k[0],Math.floor(100*(a.loaded/a.total)))},!1);return b}}).always(function(b,c,e){e="success"==c?e:b;b="success"==c?b:e.responseText;if("string"==typeof b)try{b=a.parseJSON(b)}catch(h){}DEBUG&&console.log("ajaxPress:",e.status,e.statusText,b);k.prop("disabled",!1);
var g;400<=e.status||200>e.status?g=b&&"object"==typeof b?b:e.statusText:!b||"object"!=typeof b?g="Sorry, invalid response from server.":"function"==typeof d&&!1===d.call(k[0],b,e)&&(g="string"==typeof f?f:"Sorry, response was invalidated.");g&&"function"==typeof f&&f.call(k[0],g,e)});return this},get:function(a,c,b,d){return this.ajax("GET",a,void 0,c,b,d)},post:function(a,c,b,d,f){return this.ajax("POST",a,c,b,d,f)},put:function(a,c,b,d,f){return this.ajax("PUT",a,c,b,d,f)},"delete":function(a,
